...
export async function getTranscriptionHistory(apikey, client, options = {}) {
    ...
    try {
        ...
        for (const field of required) {
            if (!(field in payload)) {
                throw new HasabApiError(`Missing required field '${field}' in pagination data`, 500);
            }
        }
        ...
        if (error instanceof AxiosError) {
            ...
            if (axiosErr.response) {
                ...
                switch (status) {
                    ...
                    case 404:
                        throw new HasabApiError("Transcription history endpoint not found", 404);
                    case 408:
        ...
        throw new HasabUnknownError(`Failed to fetch transcription history: ${msg}`);
    }
}
